    ...
    <section id="problema" className="relative py-24 md:py-32 bg-violet-950 overflow-hidden scroll-mt-28">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative">
        <div className="max-w-3xl mx-auto text-center mb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-violet-200 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed italic">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {problems.map((problem, i) => (
            <div
              key={i}
              className="group relative p-10 rounded-[2.5rem] bg-violet-900/40 border border-violet-700/50 hover:border-red-400/30 transition-all duration-500 hover:bg-violet-900/60"
            >
              <div className="flex items-start gap-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-violet-200 font-medium leading-relaxed">{problem.description}</p>
                </div>
              </div>
