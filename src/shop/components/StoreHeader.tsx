                ...
                <div className="max-w-[1440px] mx-auto flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5">
                        {whatsapp && (
                            ...
                            >
                                <img src="/logosinfondo.png" alt="" className="w-6 h-6 object-contain" />
                        ...
                        {whatsapp && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-green-500 hover:bg-green-50 rounded-xl transition-all"
                                aria-label="WhatsApp"
                            >
                    ...
                    <button
                        onClick={onCartClick}
                        className="relative ml-auto h-10 px-3 md:px-4 flex items-center gap-2 bg-primary-dynamic text-white rounded-xl shadow-lg shadow-primary-dynamic/20 hover:scale-105 active:scale-95 transition-all"
                    >
